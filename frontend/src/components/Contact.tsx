...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 sm:py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="text-center group">
                ...
                <p className="text-blue-200">info@siso-link.com</p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-blue-200">+251 911 234 567</p>
              </div>

              {/* Instagram */}
              <div className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <p className="text-blue-200">@siso_link</p>
              </div>

              {/* LinkedIn */}
              <div className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-blue-200">Siso-Link</p>
              </div>
            </div>
            ...
            <div className="text-center pt-8">
              <Link 
                href="/work-with-us"
                className="group relative inline-flex items-center justify-center px-12 py-4 text-lg font-bold text-white rounded-full shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
                style={{
